...
import com.library.service.book.IBookService;
import com.library.service.category.ICategoryService;
...
public class BookController {
    ...
    public ModelAndView listBook(@RequestParam("search")Optional<String> search){
       ...
       if (search.isPresent()){
           ...
           ModelAndView modelAndView = new ModelAndView("book/newList");
